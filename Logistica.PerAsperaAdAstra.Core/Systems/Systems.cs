...
//         var nodes = new Dictionary<string, Entity>();
//
//         // A helper lambda to reduce boilerplate when creating nodes
//         var createNode = (string name, Coordinate coords) =>
//         {
//             var entity = world.Create(
//                 new Components.Position { Value = coords },
//                 new City { Name = name }, // Using 'City' as a generic "named place"
//                 new IsGraphNode { ConnectedEdges = new List<Entity>() }
//             );
